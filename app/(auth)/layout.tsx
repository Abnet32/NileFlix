  ...
  return (
    <div className="bg-background">
      <main className="mx-auto w-full max-w-6xl px-4 py-4 md:px-6">
        ...
        <div className="flex min-h-[calc(100dvh-3.75rem)] items-center">
            ...
            <div className="relative hidden min-h-130 md:block">
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 text-white">
                ...
                <p className="mt-3 max-w-sm text-sm text-white/80">
                  Short lessons, practical exercises, and step-by-step growth
                  from fundamentals to real software projects.
                </p>
              </div>
            </div>

            <div className="flex min-h-130 items-center justify-center bg-background/80 p-4 md:p-6">
              {children}
            </div>
          </section>
        </div>
