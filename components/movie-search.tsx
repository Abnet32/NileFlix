        ...
        <div className="relative flex-1 space-y-2">
          <div className="relative">
            ...
            <input
              ...
              className={
                compact
                  ? "h-9 w-full rounded-sm border border-input bg-background pl-9 pr-9 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary/30"
                  : "h-11 w-full rounded-sm border border-input bg-background pl-11 pr-12 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary/30 sm:h-12"
              }
            />
            ...
            {query ? (
              <button
                ...
                className="absolute right-3 top-1/2 inline-flex size-7 -translate-y-1/2 items-center justify-center rounded-sm text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <select
                ...
                className="h-11 rounded-sm border border-input bg-background pl-3 pr-10 text-sm outline-none appearance-none sm:h-12"
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-sm border border-transparent bg-primary px-5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60 sm:h-12"
                  ...
                  (() => {
                    ...
                    return (
                      <Link
                        ...
                        className="flex items-center gap-3 rounded-sm p-2 transition-colors hover:bg-muted"
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="mb-1 flex items-center gap-2">
                            ...
                            <Badge
                              variant="secondary"
                              className="h-5 rounded-sm px-2 text-[10px] uppercase tracking-[0.2em]"
                            >
                              {contentType}
                            </Badge>
                          </div>
