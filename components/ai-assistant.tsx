    ...
    if (match) {
      ...
      return (
        <a
          key={i}
          href={href}
          className="mx-0.5 inline-flex items-center gap-1 rounded-md border border-primary/40 bg-primary/10 px-2 py-0.5 text-xs font-medium text-primary transition-colors hover:bg-primary/20"
        >
      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-3 sm:px-6">
        ...
        {messages.length > 0 ? (
          <button
            type="button"
            onClick={clearChat}
            className="flex items-center gap-2 rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium transition-colors hover:bg-muted"
          >
      ...
      <div className="border-t border-border px-4 py-3 sm:px-6">
        <div className="mx-auto flex w-full max-w-3xl gap-2">
          <input
            ...
            disabled={isLoading}
            className="h-11 flex-1 rounded-md border border-input bg-background px-4 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary/30"
          />
          <button
            type="button"
            onClick={handleSend}
            ...
            className="flex size-11 shrink-0 items-center justify-center rounded-md bg-primary text-primary-foreground transition-all hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50 active:scale-95"
          >
