  ...
  return (
    <main className="container mx-auto px-4 py-10 animate-pulse">
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center">
        <Skeleton className="aspect-2/3 w-full rounded-sm sm:aspect-4/5 lg:aspect-5/6" />
...
export function HeroSkeleton() {
  return (
    <div className="relative mb-8 w-full overflow-hidden rounded-sm bg-muted">
      <Skeleton className="min-h-80 w-full sm:min-h-120 lg:min-h-136 rounded-sm" />
    </div>
  );
}
